      ...
      {token ? (
        <>
          ...
          <main className="bg-sec">
                      ...
                      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div className="px-4 py-5 flex-auto">
                          ...
                          <p className="mt-2 mb-4 text-blueGray-500">
                            ...
                            Hotel. Add, modify, and customize with existing
                            ones.
                          </p>
                        </div>
                      </div>
                    ...
                    >
                      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div className="px-4 py-5 flex-auto">
                          ...
                          <h6 className="text-xl font-semibold">Room</h6>
                          <p className="mt-2 mb-4 text-primary">
                            See all rooms of Turu Hotel application. Add, set,
                    ...
                    >
                      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div className="px-4 py-5 flex-auto">
                          ...
                          <p className="mt-2 mb-4 text-primary">
                            See all users of Turu Hotel application. Add, set,
                            and modify its access rights.
                          </p>
                        </div>
                      </div>
                    </Link>
            ...
            {role === "resepsionis" ? (
              <section className="pb-20 bg-blueGray-200 -mt-36">
                <div className="container mx-auto px-36">
                  <div className="flex flex-wrap">
                    <Link
                      href="/admin/history"
                      className="w-full md:w-1/2 px-8 text-center mx-auto"
                    >
                      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div className="px-4 py-5 flex-auto">
                          <div className="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-emerald-400">
